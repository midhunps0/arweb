<div class="flex flex-row justify-between  items-center bg-white relative lg:px-7 xl:px-12 pt-4 max-w-screen-2xl mx-auto">
    <img src="/images/speciality.png" class=" bg-gray-600 bg-opacity-5 w-52 px-3 py-2  rounded-full  " alt="craft_logo">
                ...
                <li><a href="{{route('webpages.guest.show', ['locale' => app()->currentLocale(), 'slug' => 'doctors'])}}" 
                    ...
                    <div x-show="open" class="w-60 h-fit bg-white flex flex-col mx-auto  rounded-lg " x-on:click.outside="open = false">
                        <ul class=" p-6 flex flex-col gap-2 ltr:text-left rtl:text-right  ">
                            ...
                            <li><a href="{{route('webpages.guest.show', ['locale' => app()->currentLocale(), 'slug' => 'our-videos'])}}"
                                    @click.prevent.stop="$dispatch('linkaction', {link: '{{route('webpages.guest.show', ['locale' => app()->currentLocale(), 'slug' => 'our-videos'])}}'})"
