<div class="flex flex-row justify-between  items-center bg-white relative lg:px-7 xl:px-12 pt-4 max-w-screen-2xl mx-auto">
    ...
    @endphp
    <a href="{{route($route)}}" @click.prevent.stop="$dispatch('linkaction', {link: '{{route($route)}}', route: '{{$route}}'})" class="bg-darkorange rounded-full pt-2 px-1"><img src="/images/logo.webp" class=" bg-gray-600 bg-opacity-5 w-52 px-3 py-2  rounded-full  " alt="craft_logo"></a>
