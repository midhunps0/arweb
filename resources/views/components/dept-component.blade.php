...
<div x-data="{open:false}" class="relative flex justify-center" @mouseleave="open = false">
    <img src="{{$src}}" class="w-80   " alt="hospital_department_image" @mouseover="open = true" >
    <div x-show="open" class="  absolute  top-0 bg-gradient-to-b from-transparent to-black/50 rounded-3xl h-80 w-80 lg:w-full lg:h-80 transition-all duration-700 ease-in-out"></div>
